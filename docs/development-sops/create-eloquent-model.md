...
> Note: All Eloquent model tests live under `tests/Unit/`. Do not place model tests under `tests/Feature/`. Feature tests are reserved for HTTP routes, middleware, controllers, page flows, etc.
